...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ profileCompleted, onEnterPlatform }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-linkedin-background via-linkedin-dark to-linkedin-background">
      {/* Main Content */}
      <div className="max-w-6xl mx-auto px-6 py-8">
        {/* Welcome Header */}
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-white">Welcome to Venture Weavers</h1>
            <p className="text-gray-300">Let's get you started with a quick platform tour</p>
          </div>

...
interface MarketIntelligenceSidebarProps {
  activeSection: string;
  onSectionChange: (section: string) => void;
  isCollapsed?: boolean;
}

const MarketIntelligenceSidebar: React.FC<MarketIntelligenceSidebarProps> = ({ 
  activeSection, 
  onSectionChange, 
  isCollapsed = false 
}) => {
  ...
  const stats = [
    ...
    { label: 'Insights', value: '156', icon: Brain },
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Intelligence Stats - Hide when collapsed */}
      {!isCollapsed && (
        <div className="bg-linkedin-card backdrop-blur-lg rounded-xl border border-linkedin-border p-6">
          <h4 className="text-white font-semibold mb-4">Intelligence Stats</h4>
...
export default MarketIntelligenceSidebar;
...
const LeftSidebar: React.FC<LeftSidebarProps> = ({ activeSection, onSectionChange, isCollapsed = false }) => {

  const navigationTabs = [
    { id: 'feed', label: 'Activity Feed', icon: TrendingUp },
    { id: 'communities', label: 'Communities', icon: Users },
    { id: 'events', label: 'Events', icon: Calendar },
    { id: 'network', label: 'Network', icon: UserSearch },
  ...
  const stats = [
    ...
    { label: 'Followers', value: '2,156', icon: Heart },
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Social Profile Stats - Hide when collapsed */}
      {!isCollapsed && (
        <div className="bg-linkedin-card backdrop-blur-lg rounded-xl border border-linkedin-border p-6">
          <h4 className="text-white font-semibold mb-4">Profile Stats</h4>
